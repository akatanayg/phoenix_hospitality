    ...
    <div className="relative bg-[#FAF1EB] min-h-[calc(100vh+150px)] w-full flex items-center justify-center pt-[80px] p-6 md:p-10 md:pt-0">
      ...
      <div className="hidden md:grid max-w-6xl w-full grid-cols-2 gap-6 relative">
        ...
        <div className="relative flex flex-col items-end justify-center">
          <motion.h1
            ...
            className="absolute top-[-60px] left-[-600px] text-[100px] leading-[107px] font-black uppercase text-black z-20 tracking-[5px]"
          >
            PHOENIX <br />
          </motion.h1>
          <motion.h1
            ...
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 1 }}
            className="absolute top-[20px] left-[-600px] text-[100px] leading-[107px] font-black uppercase text-black z-20 tracking-[10px]"
          >
            hospitality
          </motion.h1>
      ...
      <div className="md:hidden flex flex-col items-center text-center w-full relative">
        ...
        <p className="mt-4 text-sm text-[#333333]">
          Located in Veliki Preslav, 12 km from Shumen, Mutafova Guest House
          offers rooms with free WiFi and a common lounge area with a fireplace.
          Free public parking is possible in front of the house.
        </p>
        <p className="mt-2 text-sm text-[#333333]">
          Guests can find a small museum on the premises of the house with a
          workshop. Breakfast can also be arranged for guests upon request and
          at a surcharge.
        </p>
        ...
        <div className="w-full flex flex-col items-center mt-6 space-y-4">
          ...
          <motion.img
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1.2, delay: 0.5 }}
            className="w-[85%] h-auto object-cover shadow-lg"
          />
        </div>
      </div>
    </div>
