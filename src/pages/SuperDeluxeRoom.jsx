  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Indulge in luxury with our Super Deluxe Room at Phoenix Hospitality. Spacious, elegant, and fully equipped for a premium stay in Gurgaon."
        />
        <meta
          name="keywords"
          content="Super Deluxe Room, Phoenix Hospitality, best luxury hotel, premium stay, Gurgaon hotel"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Super Deluxe Room - Phoenix Hospitality"
        />
        <meta
          property="og:description"
          content="Enjoy a high-end stay in our Super Deluxe Room with modern amenities and a luxurious ambiance. Book now!"
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://thephoenixhospitality.com/superdeluxeroom"
        />
      </Helmet>
      <div
        ...
        >
          ...
          >
            <div>
              ...
              >
                The Super Deluxe Room offers an unparalleled experience of
                comfort and grandeur. Enjoy a spacious setting with plush
                furnishings, premium amenities, and breathtaking views.
              </p>
              ...
              <ul className="text-lg mt-4 space-y-2">
                {[
                  ...
                  {
                    icon: FaCoffee,
                    text: "Mini Refrigerator & In-room Coffee Maker",
                  },
